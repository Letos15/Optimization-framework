...
def tcl_writer(desvec, vol_frac, output_filename, out_dir, compliance=False):
    '''
...
#...create the 'Skin_up' component.
*createentity comps name=component1
*retainmarkselections 1
*startnotehistorystate {Renamed component from "component1" to "Skin_up"}
*renamecollector components "component1" "Skin_up"
*retainmarkselections 0
*endnotehistorystate {Renamed component from "component1" to "Skin_up"}
...
*elementorder 1
*startnotehistorystate {Automesh surfaces}
*createmark surfaces 1 2 4 6 8-16
*interactiveremeshsurf 1 ''' + str(size) + ''' 2 2 2 1 1
*set_meshfaceparams 0 2 2 0 0 1 0.5 1 1
*automesh 0 2 2
*set_meshfaceparams 1 2 2 0 0 1 0.5 1 1
...
#Make the upper_skin component current.
*retainmarkselections 1
*currentcollector components "Skin_up"
*retainmarkselections 0

*setedgedensitylinkwithaspectratio -1
*elementorder 1
*startnotehistorystate {Automesh surfaces}
*createmark surfaces 1 1 3 5 7
*interactiveremeshsurf 1 ''' + str(size) + ''' 2 2 2 1 1
*set_meshfaceparams 0 2 2 0 0 1 0.5 1 1
*automesh 0 2 2
*set_meshfaceparams 1 2 2 0 0 1 0.5 1 1
...
# *startnotehistorystate {Deleted component "Caps "}
# *retainmarkselections 1
# *createmark components 1 "Caps"
# *deletemark components 1
# *retainmarkselections 0
# *endnotehistorystate {Deleted component "Caps "}
*createmark components 1 "Caps"
*deletemark components 1'''
...
*setvalue props id=1 name="Thickness"
...
#Assign it to the 'Skin_up' component.
*createmark components 1
*clearmark components 1
*createmark components 1 "Skin_up"
*clearmark components 1
*startnotehistorystate {Assigned "Thickness" to component "Skin_up"}
*createmark components 1 "Skin_up"
*propertyupdate components 1 "Thickness"
*endnotehistorystate {Assigned "Thickness" to component "Skin_up"}
*createmark components 1
*clearmark components 1
*startnotehistorystate {Assigned "Thickness" to component "Skin_up"}
*createmark components 1 "Skin_up"
...
#Solid property.
*createentity props cardimage=PSHELL name=property1
*setvalue props id=2 name="Solid"
...
# Identify the elements belonging to the Skin_up component.
*beginmacro
set elemIds   [ hm_elemlist id Skin_up ];
...
#Read the pressure values from the *csv file.
*createmark elements 1 [lindex $elemList 0]-[lindex $elemList $numIds-1]
*createmark loads 2
*createmark nodes 1
#*pressuresonentity_curve elements 1 1 0 0 0 0.5 30 1 0 0 0 0 0
*BCM elements 1 2 4 1 "C:/Users/NG6A38A/workspace/optimization/src/OS/pressure.csv" -100 1 30'''
